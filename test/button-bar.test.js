...
describe('Topcoat button bar', function() {
    ...
    it('should output correct desktop light css', function() {
        var actual = grunt.file.read('css/topcoat-button-bar-desktop-light.css');
        var expected = grunt.file.read('test/expected/topcoat-button-bar-desktop-light.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct desktop dark css', function() {
        var actual = grunt.file.read('css/topcoat-button-bar-desktop-dark.css');
        var expected = grunt.file.read('test/expected/topcoat-button-bar-desktop-dark.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct mobile light css', function() {
        var actual = grunt.file.read('css/topcoat-button-bar-mobile-light.css');
        var expected = grunt.file.read('test/expected/topcoat-button-bar-mobile-light.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct mobile dark css', function() {
        var actual = grunt.file.read('css/topcoat-button-bar-mobile-dark.css');
        var expected = grunt.file.read('test/expected/topcoat-button-bar-mobile-dark.css');
        assert.equal(actual, expected, 'should generate correct css');
    });
